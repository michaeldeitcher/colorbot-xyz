...
const Page = () => {
    ...
    return (
        ...
        <Container className={classes.sectionContainer}>
            ...
            <Typography variant="h6" component="h6" className={classes.sectionContainer}>Design Goals</Typography>
        ...
        <Container>
            <Typography variant="h6" component="h6" className={classes.sectionContainer}>FUSE Makerspace</Typography>
        ...
        <Container>
            <Typography variant="h4" component="h4" className={classes.sectionContainer}>Game Titles</Typography>
